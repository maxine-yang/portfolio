      ...
      {!isMobile ? (
        ...
        <div className="flex flex-col gap-6">
          {experienceDataShown.map((item, index) => (
            <div
              key={index}
              className={`flex dark:bg-white/10 dark:text-slate-100 bg-white border-1 border-opacity-80 rounded-lg p-6 pb-8 flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-8 `}
            >
